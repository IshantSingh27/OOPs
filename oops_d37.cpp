...
class cwh{
    ...
    virtual void show() = 0; // pure virtial function making this class as abstract base class.
    // abstract base class has no bjects declared and has atleast one pure virtual function.
};
...
class cwhvideo : public cwh{
    ...
    void show(){// this show() must be present as redifinition of pure virtual function is must in derived class 
